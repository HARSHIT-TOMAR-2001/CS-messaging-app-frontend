...
export default function AgentSignup({open,setOpen}) {
  ...
  const handleRegister = async () => {
    try {
      ...
      const response = await axios.post('https://css-messaging-app.herokuapp.com/api/agent/register', data);
